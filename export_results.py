    ...
    for instance_number in instance_number_list:
        for num_runways in num_runways_list:
            for objective in objectives:
                ...
                landing_times, time_diff_to_target, runway_assignment, penalty_objective, total_time_objective, makespan_objective, time_taken, ub, lb, gap = solve_mip(instance_number, num_runways, objective, time_limit=300)
